...
void RYG_BreathDimming_200K(void)
{
    ...
    ++led_i;
     ...
     {
		(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((0)<<2))))=0; 
		(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((1)<<2))))=0;
...
void RYG_BreathDimming_10K(void)
{
	...
	((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->DOUT = (((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->DOUT|(0x00000001UL)|(0x00000002UL)|(0x00000004UL))&(~((RLED<<0)|(GLED<<1)|(BLED<<2)));
	if (LED_cnt==10000)
	{
		LED_cnt=0;
		brea_cnt++;
...
void LEDTimer_TIMER0_Init(void)
{
	...
	{
    	TIMER_Open(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL)), (1UL << (27)), 10000);
		RYG_Init_10K();
	}
...
void TMR3_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL))) == 1)
    {
